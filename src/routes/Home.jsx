  ...
  <div className="grid md:grid-cols-3 gap-6 items-stretch">
    <div className="card p-6 flex flex-col h-full">
      ...
      <div className="mt-auto">
        <Link className="btn btn-primary w-full md:w-auto" to="/vendors/verkada">Explore Verkada</Link>
      </div>
    </div>
    ...
    <div className="card p-6 flex flex-col h-full">
      ...
      <div className="mt-auto">
        <Link className="btn btn-primary w-full md:w-auto" to="/vendors/avigilon">Explore Avigilon</Link>
      </div>
    </div>
