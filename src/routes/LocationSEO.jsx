...
export default function LocationSEO() {
  ...
  // Make sure titles are consistent (strip any trailing ", IL")
  ...
  // Match Canonical.jsx non-www convention (and don't set canonical here)
  ...
  // Optional: slightly richer schema for service-area pages
  const jsonLd = {
